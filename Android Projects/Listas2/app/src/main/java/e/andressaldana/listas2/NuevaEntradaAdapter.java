...
public final class NuevaEntradaAdapter extends ArrayAdapter<NuevaEntrada> {
    ...
    private ViewHolder getViewHolder(final View workingView) {
        ...
        if(null == tag || !(tag instanceof ViewHolder)) {
            ...
            vh.subTituloView = (TextView) workingView.findViewById(R.id.xtvsubtitulo); vh.imagenView = (ImageView) workingView.findViewById(R.id.xivicono);
    ...
    private static class ViewHolder { public TextView tituloView; public TextView subTituloView;
