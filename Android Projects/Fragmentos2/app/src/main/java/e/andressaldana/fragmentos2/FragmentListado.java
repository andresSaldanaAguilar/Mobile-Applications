package e.andressaldana.fragmentos2;
...
public class FragmentListado extends Fragment {
    private Grupo[] datos = new Grupo[]{
            new Grupo("\nEstudiante 1", "Calificación 1", "\nReporte de aprovechamiento 1"),
            new Grupo("\nEstudiante 2", "Calificación 2", "\nReporte de aprovechamiento 2"),
            new Grupo("\nEstudiante 3", "Calificación 3", "\nReporte de aprovechamiento 3"),
            new Grupo("\nEstudiante 4", "Calificación 4", "\nReporte de aprovechamiento 4"),
            new Grupo("\nEstudiante 5", "Calificación 5", "\nReporte de aprovechamiento 5")
    };
    private ListView lv;
