...
public class Lienzo extends View {
    ...
    protected void onDraw(Canvas c) {
        ...
        line(c, p, 6, 7); line(c, p, 7, 0); //base
        line(c, p, 0, 8); line(c, p, 1, 8); line(c, p, 2, 8); line(c, p, 3, 8); line(c, p, 4, 8); line(c, p, 5, 8);
        line(c, p, 6, 8); line(c, p, 7, 8); //punta
    }
