package e.andressaldana.codigobarrasqr;
...
public class MainActivity extends Activity {
    ...
    public void scanBarra(View v) {
        ...
        } catch (ActivityNotFoundException anfe) { //Al obtenerlo, muestra diálogo de descarga showDialog(MainActivity.this, "No hay scanner", "Descargar scanner?", "Si", "No").show();
        } }
