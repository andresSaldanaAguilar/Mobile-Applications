package e.andressaldana.spinner2;
...
import android.view.inputmethod.InputMethodManager; import android.widget.AdapterView.OnItemSelectedListener; import android.widget.*;
public class MainActivity extends Activity implements OnItemSelectedListener {
    Spinner jsp1;
    Button jbn1;
    EditText jet1; @Override
    ...
    public void onItemSelected(AdapterView<?> av, View v, int i, long l) {
        String s = av.getItemAtPosition(i).toString(); Toast.makeText(av.getContext(), "Selección: " + s, Toast.LENGTH_LONG).show();
    }
    @Override
