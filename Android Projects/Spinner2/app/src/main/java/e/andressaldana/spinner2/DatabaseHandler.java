...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    @Override
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) { db.execSQL("DROP TABLE IF EXISTS " + TABLE_LABELS);
        onCreate(db);
    }
    ...
    public List<String> getAllLabels(){
        ...
        String q = "SELECT * FROM " + TABLE_LABELS; SQLiteDatabase db = this.getReadableDatabase();
